      ...
      <main>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-2xl font-extrabold text-slate-900 mb-6">Why Choose Our {title}?</h2>
              ...
              <Link
                href="/#contact"
                className="inline-block mt-8 bg-teal-600 hover:bg-teal-700 text-white font-bold px-8 py-3.5 rounded-full transition-all hover:scale-105"
              >
                Book {title} Now
              </Link>
            </div>
        ...
        <section className="py-14 bg-teal-50 border-y border-teal-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-xl font-bold text-slate-900 mb-4">{title} Available In:</h2>
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-5">
                {faq.map((item) => (
                  <details
                    key={item.q}
                    className="border border-slate-200 rounded-xl p-5 group"
                  >
