...
export const en: Translation = {
  ...
  contact: {
    ...
    successSubtitle: "Berenice received your request and will contact you within 2 hours to confirm.",
    refLabel: "Reference",
    sendToBerenice: "💬 Send to Berenice via WhatsApp",
    sendCopy: "📩 Send copy to my WhatsApp",
    downloadPdf: "⬇️ Download PDF Quote",
    newQuote: "Request another quote",
    pdf: {
      title: "Berenice's Sparkle Clean",
      subtitle: "Professional Cleaning Services — Boise, Idaho",
      ...
      labelNotes: "NOTES / ADDITIONAL DETAILS",
      noNotes: "No additional notes provided.",
      footer: "Berenice's Sparkle Clean | Boise, Idaho | (208) 919-6397 | berenicessparkleclean.com",
      guarantee: "✓ Insured & Bonded  ✓ 20 Years Experience  ✓ 100% Satisfaction Guarantee  ✓ Bilingual",
      validDays: "This quote request is valid for 30 days.",
    },
    wa: {
      bereniceHeader: "🧹 *NEW QUOTE REQUEST — Berenice's Sparkle Clean*",
      clientSection: "👤 *CLIENT INFORMATION*",
      serviceSection: "🏠 *SERVICE REQUESTED*",
      notesSection: "💬 *NOTES*",
      clientHeader: "✅ *QUOTE REQUEST SENT — Berenice's Sparkle Clean*",
      clientGreeting: "Hi! Your cleaning quote request has been sent. Berenice will contact you within 2 hours.",
      clientSummary: "📋 *Your request summary:*",
      questions: "Questions? Call or WhatsApp:",
    },
  },
